...
COMMANDS = [
    ...
    [sys.executable, "cad/generate_m6_large_v1.py"],
    [sys.executable, "scripts/normalize_m6_step.py"],
]
...
print("Source-reproducible CAD families rebuilt, including deterministic V4 and M6 STEP metadata.")
