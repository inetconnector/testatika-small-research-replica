...
ZIP=OUT/"testatika-m6-v2-fabrication-kit.zip"; SHA=ZIP.with_suffix(ZIP.suffix+".sha256")
FILES=[
 "cad/generate_m6_v2_fabrication_kit.py","scripts/check_build_kits.py","scripts/normalize_buildkit_step.py",
 "docs/build-kits.md","docs/research/m6-v2-fabrication-kit.md","docs/research/m6-large-v1-bom.md","docs/research/m6-large-v1-assembly.md",
 "docs/research/m6-large-v1-electrical-boundary.md","docs/research/safety.md","docs/M6_REPLICATION_STATUS.md"]
DIRS=["hardware/build-kits/m6-v2"]
